...
Codes
The targed SQL queries regarding various business questions can be found here.
The interactive Tableau dashboard used to report and explore sales trends can be found here.
The Python Pipeline used for EDA, Model Building for Recommendation Systems and Deployment of model can be found here.
The Recommendation App demo can be found here.
Dashboard
<img width="1113" height="491" alt="image" src="https://github.com/user-attachments/assets/09180f4f-ccf6-42ea-9d5d-79979c02914a" />
Insights
